			...
			(cond																		;----cond block
				...
				(setq first3 (strcat character1 character2 character3))
				 	...
				 	(cond	((= first3 "WS-")
						...
						(write-line (strcat "_.open \""  dir "\\" x "\" (WATTSTOPPER-ROOMID-FORMAT) (wscplbatch) (c:wstbimport) ._qsave _.close") ofile) 			;write the lines to copy and paste			

...
(defun c:acadoptions ( / *FILES* ISNEWFOLDERSTRUCTURE ISTOOLPALETTEDEVELOPER LST SSFPSRETURN USERNAME)
	...
	(if (>= (getvar "ACADVER") "19.1")
	  	(progn
		(setvar "trustedpaths" "C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Vantage Riser;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Run Time Updates;C:\\WS_Blocks\\Custom\\LISP_Custom;C:\\WS_Blocks\\Default\\LISP;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions;C:\\WS_Blocks\\Default\\LISP\\DCL Dialog Boxes;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\DLM Riser;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Drawing Utilities;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Functions for Cable;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Functions for Layout Blocks;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Room Details;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Script Creators;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Titleblocks;C:\\WS_Blocks\\Default\\LISP\\Lisp Functions\\Vantage Riser;")
		)
	)
